...
RSpec.describe AddressBook do
  ...
  def check_entry(entry, expected_name, expected_number, expcected_emaiL)
    ...
    expect(entry.email).to eq expcected_emaiL
  end
  ...
  describe "#binary_search" do
    it "seraches AddressBook for a non-existent entry" do
      book.import_from_csv("entries.csv")
  ...
  # Tests iterative_search
  describe "#iterative_search" do
    it "seraches AddressBook for non-existent entry" do
      book.import_from_csv("entries.csv")
